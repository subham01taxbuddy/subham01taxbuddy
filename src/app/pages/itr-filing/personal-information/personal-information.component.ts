...
export class PersonalInformationComponent implements OnInit {
  ...
  uploadDoc: any;
  docType: any = [{value:'PAN', label: 'Pan card'}, {value:'ADHAR', label: 'Adhar card'}, {value:'FORM16', label: 'Fomr 16'}]
  ...
  uploadDocument(type, document){
      console.log('Type: ',type, ' Documents: ',document)
  }
}
