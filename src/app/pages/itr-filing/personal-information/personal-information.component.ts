...
export class PersonalInformationComponent implements OnInit {
  ...
  docUrl = '';
  deletedFileData: any = [];
  lastFilingDetailsNeeded: boolean = false;
  ...
  onRegimeChanged() {
    if (this.customerProfileForm.controls['regime'].value === 'NEW' ||
      ...
      this.lastFilingDetailsNeeded = false;
      this.customerProfileForm.controls['form10IEAckNo'].reset();
      this.customerProfileForm.controls['form10IEDate'].reset();
      this.customerProfileForm.controls['form10IEAckNo'].setValidators(null);
      this.customerProfileForm.controls['form10IEAckNo'].updateValueAndValidity();
      this.customerProfileForm.controls['form10IEDate'].setValidators(null);
      this.customerProfileForm.controls['form10IEDate'].updateValueAndValidity();
    }
  }
