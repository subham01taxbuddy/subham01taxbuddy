...
@Component({
  selector: 'app-add-deduction-second',
  templateUrl: './add-deduction-second.component.html',
  styleUrls: ['./add-deduction-second.component.scss']
})
export class AddDeductionSecondComponent implements OnInit {
