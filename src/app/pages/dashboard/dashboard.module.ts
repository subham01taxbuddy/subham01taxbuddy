...
@NgModule({
    declarations: [DashboardComponent, NewUserComponent, EngagementComponent, KommunicateComponent, WhatsappComponent, CallingBoardComponent, TodaysCallsComponent, InterestedClientsComponent, OpenComponent],
    imports: [
        CommonModule,
        FormsModule,
        ReactiveFormsModule,
