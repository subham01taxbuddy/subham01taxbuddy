...
export class TokenInterceptor implements HttpInterceptor {
  ...
  intercept(
    ...
    } else if ((request.url.startsWith(environment.reviewUrl)) || (request.url.startsWith(environment.update_id)) || (request.url.startsWith(environment.get_adjustment)) ||(request.url.startsWith(environment.add_adjustment))) {
      request = request.clone({
        setHeaders: {
          Authorization: `Bearer ` + TOKEN,
