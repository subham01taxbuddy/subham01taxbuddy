...
@Component({
  selector: 'app-main-knowlarity',
  templateUrl: './main-knowlarity.component.html',
  styleUrls: ['./main-knowlarity.component.css']
})
export class MainKnowlarityComponent implements OnInit {
