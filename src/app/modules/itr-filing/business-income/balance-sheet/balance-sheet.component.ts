...
export class BalanceSheetComponent implements OnInit {
  ...
  initForm(obj?: NewFinancialParticulars) {
    this.assetLiabilitiesForm = this.fb.group({
      ...
      sundryCreditorsAmount: [obj?.sundryCreditorsAmount, [Validators.required, Validators.pattern(AppConstants.numericRegex)]],
      ...
      inventories: [obj?.inventories, [Validators.required, Validators.pattern(AppConstants.numericRegex)]],
      sundryDebtorsAmount: [obj?.sundryDebtorsAmount, [Validators.required, Validators.pattern(AppConstants.numericRegex)]],
      balanceWithBank: [obj?.balanceWithBank, Validators.pattern(AppConstants.numericRegex)],
      cashInHand: [obj?.cashInHand, [Validators.required, Validators.pattern(AppConstants.numericRegex)]],
