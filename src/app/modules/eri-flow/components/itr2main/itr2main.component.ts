...
export class Itr2mainComponent implements OnInit, OnChanges {
  ...
  { value: '2019-2020', label: '2019' }, { value: '2020-2021', label: '2020' }, { value: '2021-2022', label: '2021' }, { value: '2022-2023', label: '2022' }]
  ...
  setJsonData(itrData) {
    ...
    if (itrData.hasOwnProperty('ScheduleOS') && itrData.ScheduleOS.hasOwnProperty('IncOthThanOwnRaceHorse')) {
      ...
      if (otherInfo.hasOwnProperty('FamilyPension') || otherInfo.hasOwnProperty('Deductions')) {
        ...
        this.otherSourceForm.controls['familyPension'].setValue(Number(familyPension) - Number(DeductionUs57iia));
      }
      else {
      ...
      let otherTotal = this.otherSourceForm.controls['dividend'].value + this.otherSourceForm.controls['interestFromSaving'].value + this.otherSourceForm.controls['interestFromTaxRefund'].value + this.otherSourceForm.controls['other'].value
        + this.otherSourceForm.controls['interestFromDeposite'].value + + this.otherSourceForm.controls['familyPension'].value;
  ...
  itr3JSONBind(itr3Info) {
    ...
    SundryCred = financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.CurrLiabilities.hasOwnProperty('SundryCred') ? this.getNumberFormat(financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.CurrLiabilities.SundryCred) : 0;
    TotCurrLiabilities = financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.CurrLiabilities.hasOwnProperty('TotCurrLiabilities') ? this.getNumberFormat(financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.CurrLiabilities.TotCurrLiabilities) : 0;
    itr3Summary.assesse.business.financialParticulars.sundryCreditorsAmount = SundryCred + TotCurrLiabilities;

    let TotProvisions = 0;
    TotProvisions = financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.Provisions.hasOwnProperty('TotProvisions') ? this.getNumberFormat(financialInfo.FundApply.CurrAssetLoanAdv.CurrLiabilitiesProv.Provisions.TotProvisions) : 0;
    itr3Summary.assesse.business.financialParticulars.otherLiabilities = this.getNumberFormat(financialInfo.FundSrc.DeferredTax) + TotProvisions;
  ...
  calculateOtherSourceTotal() {
    let total = Number(this.otherSourceForm.controls['interestFromSaving'].value) + Number(this.otherSourceForm.controls['interestFromDeposite'].value) + Number(this.otherSourceForm.controls['interestFromTaxRefund'].value)
      + Number(this.otherSourceForm.controls['other'].value) + Number(this.otherSourceForm.controls['dividend'].value) + Number(this.otherSourceForm.controls['familyPension'].value);    //+ Number(this.otherSourceForm.controls['agricultureIncome.value) + Number(this.otherSourceForm.controls['dividendIncome.value);
    ...
    if (otherSource.length > 0) {
      for (let i = 0; i < otherSource.length; i++) {
        ...
        this.sourcesOfIncome.total = this.sourcesOfIncome.interestFromSaving + this.sourcesOfIncome.interestFromDeposite +
          this.sourcesOfIncome.interestFromTaxRefund + this.sourcesOfIncome.other + this.sourcesOfIncome.familyPension;
