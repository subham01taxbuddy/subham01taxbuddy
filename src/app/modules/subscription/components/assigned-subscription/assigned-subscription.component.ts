...
export class AssignedSubscriptionComponent implements OnInit, OnDestroy {
  ...
  async downloadReport() {
    ...
    let fieldName = [
      ...
      { key: 'smeSelectedPlan[0].promoApplied.discountedAmount', value: 'Sme Selected discounted Amount' },
      { key: 'userSelectedPlan.totalAmount', value: 'User Selected Total Amount' },
      { key: 'userSelectedPlan[0].promoApplied.discountedAmount', value: 'User Selected discounted Amount' },
